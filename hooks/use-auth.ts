...
import { onUserSignup, onUserLogin, onUserLogout } from "@/lib/auth-actions";
...
export function useAuth(options: UseAuthOptions = {}) {
  ...
  const signIn = async (params: SignInParams) => {
    ...
    try {
      ...
      // Note: Guest data migration will be handled automatically by the useGuestDetection hook
      // which monitors authentication state changes and triggers migration when appropriate
